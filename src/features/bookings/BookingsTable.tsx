...
import { BookingsType, checkOut, deleteBooking } from '@/services/api/bookingsApi';
...
const BookingsTable = ({ bookings }: { bookings: BookingsType[] }) => {
  const [deleteDialogInfo, setDeleteDialogInfo] = useState<{ id: number | null; open: boolean }>({
    id: null,
    open: false,
  });
      ...
      >
        ...
        <Table.Header backgroundColor='var(--color-grey-50)'>
          <Table.Row>
            ...
            <Table.ColumnHeader className='table-head'>DATES</Table.ColumnHeader>
            ...
            >
              ...
              <Table.Cell>
                <Flex fontSize='.85rem' fontWeight='500'>
                  {formatTimeToNow(booking.startDate)} &rarr; {booking.numNights} nights stay
                </Flex>
              ...
              <Table.Cell textAlign='end'>
                <MenuContainer>
                  ...
                  {booking.status === 'unconfirmed' && (
                    <Menu.Item value='check-in' color='var(--color-grey-600)' asChild>
