...
import { BookingDetails, deleteBooking, getBookingById } from '@/services/api/bookingsApi';
import { formatDateToReadable, formatTimeToNow, formatToUSCurrency } from '@/utils/helper';
import { Box, Button, Circle, Container, Flex, Stack, Text } from '@chakra-ui/react';
  ...
  return isLoading || booking === undefined ? (
    ...
    <>
      ...
      <Flex justifyContent='end' gap='4'>
        <Button bgColor='var(--color-brand-600)' _hover={{ bgColor: 'var(--color-brand-700)' }}>
