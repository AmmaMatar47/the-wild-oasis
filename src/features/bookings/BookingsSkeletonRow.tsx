import { Skeleton, SkeletonText, Table, Flex } from '@chakra-ui/react';
...
const BookingsSkeletonRow = () => {
  return (
    ...
    >
      ...
      <Table.Cell w='10rem' paddingRight='3rem'>
        <Skeleton h='4' />
      </Table.Cell>
      ...
      <Table.Cell width='10%'>
        <Flex display='flex' justifyContent='end' alignItems='center' paddingRight='2rem'>
