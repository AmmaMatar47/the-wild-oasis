  ...
  return (
    <Stack marginBottom='8' gap='0' boxShadow='var(--shadow-sm)'>
      <Flex
        ...
        color='#fff'
      >
        <Container display='flex' fontSize='lg' fontWeight='500' gap='3' alignItems='center'>
      ...
      >
        <Flex padding='0' gap='3' alignItems='center' marginBottom='6'>
          ...
          <Circle size='1' bgColor='var(--color-grey-500)' />
          <Text color='var(--color-grey-500)'>National ID {booking.guests.nationalID}</Text>
        </Flex>

        <Flex alignItems='center' gap='2' marginBottom='3'>
          <HiOutlineChatBubbleBottomCenterText stroke='var(--color-brand-500)' size={20} />
        ...
        <Box
          display='flex'
          bgColor={booking.isPaid ? `var(--color-green-100)` : `var(--color-yellow-100)`}
          color={booking.isPaid ? `var(--color-green-700)` : `var(--color-yellow-700)`}
          padding='6'
        ...
        >
          ...
          <Text fontSize='sm'>{booking.isPaid ? 'PAID' : 'WILL PAY AT PROPERTY'}</Text>
        </Box>
