import { FileUpload, Field, FileUploadList, FileUploadRootProps } from '@chakra-ui/react';
...
const ImageUploadField = ({ label, ...props }: ImageUploadFieldProps) => {
  return (
    <Field.Root orientation='horizontal' justifyContent='start'>
      ...
      <FileUpload.Root accept='image/*' name='image' flexDir='row' maxW='20rem' {...props}>
        <FileUpload.HiddenInput />
        <FileUpload.Trigger asChild>
          <Button variant='outline' size='sm' fontSize='sm' color='var(--color-grey-100)'>
