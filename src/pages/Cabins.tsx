import { createListCollection, Flex, Heading, Portal, Select } from '@chakra-ui/react';
  ...
  useEffect(() => {
    const fetchCabins = async () => {
      ...
      const cabinsData = await getCabins(
        activeSegment === 'All' ? selectedValue : { ...selectedValue, discount: activeSegment }
      );
  ...
  return (
    <div>
      <Flex justifyContent='space-between'>
        ...
        <Flex gapX='1.125rem'>
          <Segment items={segmentItems} value={activeSegment} setValue={setActiveSegment} />
      ...
      {isLoading ? <Spinner /> : <CabinsTable setCabins={setCabins} cabins={cabins} />}
